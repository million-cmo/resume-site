...
describe("resume site user journeys", () => {
  ...
  it("switches page copy, skill labels, tags, title and document language both ways", () => {
    ...
    expect(screen.getByText("data@zszzs.cn").closest("a").getAttribute("href")).toBe("mailto:data@zszzs.cn");
    expect(screen.getByRole("button", { name: /微信 zszzs123/ })).toBeTruthy();
    ...
    expect(screen.getByText("data@zszzs.cn").closest("a").getAttribute("href")).toBe("mailto:data@zszzs.cn");
    expect(screen.getByRole("button", { name: /WECHAT zszzs123/ })).toBeTruthy();
